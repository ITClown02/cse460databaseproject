-- queries.sql
-- Copy of nfl_analysis_queries.sql for standard query execution.
...
-- 21) Procedure and transaction demo: insert/update/delete/select
SELECT insert_team(9998, 'Demo Team', 'DEMO', 'Unknown', 'Unknown', 2026);
SELECT update_team_abbr(9998, 'DMO');
SELECT delete_penalty(999999999);
SELECT * FROM select_player_game_summary(20010032)
LIMIT 10;

-- 22) Transaction failure demonstration and logging
SELECT demo_failed_transaction_update(9998, 'FAIL');
